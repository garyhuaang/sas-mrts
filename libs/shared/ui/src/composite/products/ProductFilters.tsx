  ...
  return (
    <div className="flex min-h-full flex-col gap-8">
      ...
      <div className="flex flex-col space-y-4">
        ...
        <Slider
          defaultValue={[productsState.priceRange]}
          max={599.99}
          min={85.0}
      ...
      <ProductCheckboxes
        ...
        label="Categories"
        onClickCheckbox={(content: string) => dispatch(setCategory(content))}
      ...
      <ProductCheckboxes
        ...
        label="Companies"
        onClickCheckbox={(content: string) => dispatch(setCompany(content))}
